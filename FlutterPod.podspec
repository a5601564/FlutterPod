...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kongdelu/FlutterPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kongdelu' => 'kongdelu2009@yeah.net' }
  s.source           = { :git => 'https://github.com/kongdelu/FlutterPod.git', :tag => s.version.to_s }
